...
default_args={
    "owner": "stan.kidd@performancearchitects.com,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-05-28", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "stan.kidd@performancearchitects.com": "mailto:stan.kidd@performancearchitects.com",
        "Open in Cloud IDE": "https://cloud.astronomer.io/clwicwa1k01q901mjnt7dxl5x/cloud-ide/clwiihhcn028801nnbbwr68mx/clwiihhkw02dm01mj2fy9ssjk",
    },
)
